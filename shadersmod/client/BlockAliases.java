...
public class BlockAliases {
  ...
  public static void update(IShaderPack shaderPack) {
    ...
    try {
      ...
      for (Object s10 : propertiesOrdered.keySet()) {
        String s1 = (String)s10;
        String s2 = propertiesOrdered.getProperty(s1);
        String s3 = "block.";
        if (!s1.startsWith(s3)) {
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\shadersmod\client\BlockAliases.class
