...
public class ShadersRender {
  ...
  public static void renderShadowMap(EntityRenderer entityRenderer, int pass, float partialTicks, long finishTimeNano) {
    if (Shaders.usedShadowDepthBuffers > 0 && --Shaders.shadowPassCounter <= 0) {
      ...
      ActiveRenderInfo.updateRenderInfo((EntityPlayer)minecraft.thePlayer, (minecraft.gameSettings.thirdPersonView == 2));
      ...
      renderglobal.setupTerrain(entity, partialTicks, (ICamera)frustum, i, minecraft.thePlayer.isSpectator());
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\shadersmod\client\ShadersRender.class
