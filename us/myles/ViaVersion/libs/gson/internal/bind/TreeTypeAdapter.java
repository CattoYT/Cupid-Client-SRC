...
public final class TreeTypeAdapter<T> extends TypeAdapter<T> {
  ...
  private static final class SingleTypeFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return matches ? 
        new TreeTypeAdapter<T>((JsonSerializer)this.serializer, (JsonDeserializer)this.deserializer, gson, type, this) : 
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\viaversion\libs\gson\internal\bind\TreeTypeAdapter.class
