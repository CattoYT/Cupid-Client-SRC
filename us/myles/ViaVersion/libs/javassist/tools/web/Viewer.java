...
public class Viewer extends ClassLoader {
  ...
  protected Class<?> findClass(String name) throws ClassNotFoundException {
    ...
    if (name.startsWith("java.") || name.startsWith("javax.") || name
      .equals("us.myles.viaversion.libs.javassist.tools.web.Viewer"))
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\viaversion\libs\javassist\tools\web\Viewer.class
