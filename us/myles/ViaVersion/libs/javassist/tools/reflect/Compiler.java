    ...
    for (i = 0; i < n; i++) {
      ...
      if ((entries[i]).metaobject != null || (entries[i]).classobject != null) {
        ...
        if ((entries[i]).metaobject == null) {
          metaobj = "us.myles.viaversion.libs.javassist.tools.reflect.Metaobject";
        } else {
          metaobj = (entries[i]).metaobject;
        } 
        if ((entries[i]).classobject == null) {
          classobj = "us.myles.viaversion.libs.javassist.tools.reflect.ClassMetaobject";
        } else {
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\viaversion\libs\javassist\tools\reflect\Compiler.class
