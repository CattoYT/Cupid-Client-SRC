...
import us.myles.viaversion.libs.javassist.bytecode.DuplicateMemberException;
import us.myles.viaversion.libs.javassist.bytecode.ExceptionsAttribute;
...
public class ProxyFactory {
  ...
  private static final String NULL_INTERCEPTOR_HOLDER = "us.myles.viaversion.libs.javassist.util.proxy.RuntimeSupport";
  ...
  private Class<?> getClassInTheSamePackage() {
    if (this.basename.startsWith("us.myles.viaversion.libs.javassist.util.proxy."))
      return getClass(); 
  ...
  private static final String packageForJavaBase = "us.myles.viaversion.libs.javassist.util.proxy.";
  ...
  private void checkClassAndSuperName() {
    ...
    if (this.basename.startsWith("java.") || this.basename.startsWith("jdk.") || onlyPublicMethods)
      this.basename = "us.myles.viaversion.libs.javassist.util.proxy." + this.basename.replace('.', '_'); 
  }
  ...
  private static MethodInfo makeConstructor(String thisClassName, Constructor<?> cons, ConstPool cp, Class<?> superClass, boolean doHandlerInit) {
    ...
    code.addAload(0);
    code.addGetstatic("us.myles.viaversion.libs.javassist.util.proxy.RuntimeSupport", "default_interceptor", HANDLER_TYPE);
    code.addPutfield(thisClassName, "handler", HANDLER_TYPE);
  ...
  private static MethodInfo makeWriteReplace(ConstPool cp) {
    ...
    code.addAload(0);
    code.addInvokestatic("us.myles.viaversion.libs.javassist.util.proxy.RuntimeSupport", "makeSerializedProxy", "(Ljava/lang/Object;)Ljavassist/util/proxy/SerializedProxy;");
    code.addOpcode(176);
    minfo.setCodeAttribute(code.toCodeAttribute());
    return minfo;
  }
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\viaversion\libs\javassis\\util\proxy\ProxyFactory.class
