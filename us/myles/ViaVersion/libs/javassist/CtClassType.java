...
import us.myles.viaversion.libs.javassist.bytecode.ConstantAttribute;
import us.myles.viaversion.libs.javassist.bytecode.Descriptor;
import us.myles.viaversion.libs.javassist.bytecode.EnclosingMethodAttribute;
import us.myles.viaversion.libs.javassist.bytecode.FieldInfo;
import us.myles.viaversion.libs.javassist.bytecode.InnerClassesAttribute;
...
import us.myles.viaversion.libs.javassist.compiler.AccessorMaker;
...
class CtClassType extends CtClass {
  ...
  public ClassFile getClassFile3(boolean doCompress) {
    ...
    try {
      fin = this.classPool.openClassfile(getName());
      if (fin == null)
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\viaversion\libs\javassist\CtClassType.class
