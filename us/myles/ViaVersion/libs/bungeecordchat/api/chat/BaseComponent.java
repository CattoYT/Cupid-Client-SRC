...
public abstract class BaseComponent {
  ...
  public String toString() {
    return "BaseComponent(color=" + getColor() + ", font=" + getFont() + ", bold=" + this.bold + ", italic=" + this.italic + ", underlined=" + this.underlined + ", strikethrough=" + this.strikethrough + ", obfuscated=" + this.obfuscated + ", insertion=" + getInsertion() + ", extra=" + getExtra() + ", clickEvent=" + getClickEvent() + ", hoverEvent=" + getHoverEvent() + ")";
  }
  ...
  public boolean equals(Object o) {
    ...
    if ((this$insertion == null) ? (other$insertion != null) : !this$insertion.equals(other$insertion))
      return false; 
    Object<BaseComponent> this$extra = (Object<BaseComponent>)getExtra(), other$extra = (Object<BaseComponent>)other.getExtra();
  ...
  public int hashCode() {
    ...
    Object<BaseComponent> $extra = (Object<BaseComponent>)getExtra();
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\viaversion\libs\bungeecordchat\api\chat\BaseComponent.class
