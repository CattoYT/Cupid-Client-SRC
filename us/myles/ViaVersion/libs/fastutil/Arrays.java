...
import us.myles.viaversion.libs.fastutil.ints.IntComparator;
...
public class Arrays {
  ...
  protected static class ForkJoinGenericQuickSort extends RecursiveAction {
    ...
    protected void compute() {
      ...
      int t = d - c;
      if (s > 1 && t > 1) {
        invokeAll(new ForkJoinGenericQuickSort(this.from, this.from + s, this.comp, this.swapper), new ForkJoinGenericQuickSort(this.to - t, this.to, this.comp, this.swapper));
      } else if (s > 1) {
        invokeAll((ForkJoinTask<?>[])new ForkJoinTask[] { new ForkJoinGenericQuickSort(this.from, this.from + s, this.comp, this.swapper) });
      } else {
        invokeAll((ForkJoinTask<?>[])new ForkJoinTask[] { new ForkJoinGenericQuickSort(this.to - t, this.to, this.comp, this.swapper) });
      } 
    }
  }
  ...
  public static void quickSort(int from, int to, IntComparator comp, Swapper swapper) {
    ...
    if (len > 128) {
      int i = len / 8;
      l = med3(l, l + i, l + 2 * i, comp);
      m = med3(m - i, m, m + i, comp);
      n = med3(n - 2 * i, n - i, n, comp);
    } 
    m = med3(l, m, n, comp);
    int a = from;
    int b = a;
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\viaversion\libs\fastutil\Arrays.class
