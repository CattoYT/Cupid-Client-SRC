...
public class SpawnEggRewriter {
  ...
  public static Optional<String> getEntityId(int spawnEggId) {
    ...
    return Optional.ofNullable(spawnEggs.inverse().get(Integer.valueOf(spawnEggId & 0xFFFF)));
  }
}


/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\ViaVersion\protocols\protocol1_13to1_12_2\data\SpawnEggRewriter.class
