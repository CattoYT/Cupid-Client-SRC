...
public class WorldPackets {
  ...
  public static void register(Protocol protocol) {
    protocol.registerOutgoing((ClientboundPacketType)ClientboundPackets1_12_1.SPAWN_PAINTING, new PacketRemapper() {
    ...
    protocol.registerOutgoing((ClientboundPacketType)ClientboundPackets1_12_1.BLOCK_ENTITY_DATA, new PacketRemapper() {
          public void registerMap() {
            map(Type.POSITION);
    ...
    protocol.registerOutgoing((ClientboundPacketType)ClientboundPackets1_12_1.BLOCK_ACTION, new PacketRemapper() {
          public void registerMap() {
            map(Type.POSITION);
            map(Type.UNSIGNED_BYTE);
            map(Type.UNSIGNED_BYTE);
    ...
    protocol.registerOutgoing((ClientboundPacketType)ClientboundPackets1_12_1.BLOCK_CHANGE, new PacketRemapper() {
          public void registerMap() {
            map(Type.POSITION);
            map((Type)Type.VAR_INT);
            handler(new PacketHandler() {
    ...
    protocol.registerOutgoing((ClientboundPacketType)ClientboundPackets1_12_1.MULTI_BLOCK_CHANGE, new PacketRemapper() {
          public void registerMap() {
            map(Type.INT);
            map(Type.INT);
    ...
    protocol.registerOutgoing((ClientboundPacketType)ClientboundPackets1_12_1.EXPLOSION, new PacketRemapper() {
          public void registerMap() {
            if (!Via.getConfig().isServersideBlockConnections())
              return; 
            map((Type)Type.FLOAT);
    ...
    protocol.registerOutgoing((ClientboundPacketType)ClientboundPackets1_12_1.UNLOAD_CHUNK, new PacketRemapper() {
          public void registerMap() {
            if (Via.getConfig().isServersideBlockConnections())
              handler(new PacketHandler() {
                    public void handle(PacketWrapper wrapper) throws Exception {
    ...
    protocol.registerOutgoing((ClientboundPacketType)ClientboundPackets1_12_1.NAMED_SOUND, new PacketRemapper() {
          public void registerMap() {
            map(Type.STRING);
            handler(new PacketHandler() {
                  public void handle(PacketWrapper wrapper) throws Exception {
    ...
    protocol.registerOutgoing((ClientboundPacketType)ClientboundPackets1_12_1.CHUNK_DATA, new PacketRemapper() {
          public void registerMap() {
            handler(new PacketHandler() {
                  public void handle(PacketWrapper wrapper) throws Exception {
    ...
    protocol.registerOutgoing((ClientboundPacketType)ClientboundPackets1_12_1.SPAWN_PARTICLE, new PacketRemapper() {
          public void registerMap() {
            map(Type.INT);
            map(Type.BOOLEAN);
            map((Type)Type.FLOAT);
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\ViaVersion\protocols\protocol1_13to1_12_2\packets\WorldPackets.class
