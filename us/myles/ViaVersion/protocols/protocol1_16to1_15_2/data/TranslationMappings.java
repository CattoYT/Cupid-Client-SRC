...
public class TranslationMappings extends ComponentRewriter {
  ...
  public void processText(JsonElement element) {
    ...
    if (value != null) {
      object.remove("score");
      object.add("text", (JsonElement)value);
    } 
  }
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\ViaVersion\protocols\protocol1_16to1_15_2\data\TranslationMappings.class
