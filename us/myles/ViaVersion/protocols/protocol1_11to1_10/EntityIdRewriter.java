...
public class EntityIdRewriter {
  private static final BiMap<String, String> oldToNewNames = (BiMap<String, String>)HashBiMap.create();
  ...
  public static void toClientItem(Item item, boolean backwards) {
    if (hasEntityTag(item))
      toClient((CompoundTag)item.getTag().get("EntityTag"), backwards); 
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\ViaVersion\protocols\protocol1_11to1_10\EntityIdRewriter.class
