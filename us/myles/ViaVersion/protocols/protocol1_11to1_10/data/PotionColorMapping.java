...
public class PotionColorMapping {
  private static final Int2ObjectMap<Pair<Integer, Boolean>> POTIONS = (Int2ObjectMap<Pair<Integer, Boolean>>)new Int2ObjectOpenHashMap(37, 1.0F);
  ...
  public static Pair<Integer, Boolean> getNewData(int oldData) {
    return (Pair<Integer, Boolean>)POTIONS.get(oldData);
  }
  
  private static void addRewrite(int oldData, int newData, boolean isInstant) {
    POTIONS.put(oldData, new Pair(Integer.valueOf(newData), Boolean.valueOf(isInstant)));
  }
}


/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\ViaVersion\protocols\protocol1_11to1_10\data\PotionColorMapping.class
