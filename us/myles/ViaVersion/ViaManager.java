...
public class ViaManager {
  ...
  public void onServerLoaded() {
    ...
    if (ProtocolRegistry.SERVER_PROTOCOL < ProtocolVersion.v1_9.getVersion() && 
      Via.getConfig().isSimulatePlayerTick())
      Via.getPlatform().runRepeatingSync((Runnable)new ViaIdleThread(), Long.valueOf(1L)); 
    if (ProtocolRegistry.SERVER_PROTOCOL < ProtocolVersion.v1_13.getVersion() && 
      Via.getConfig().get1_13TabCompleteDelay() > 0)
      Via.getPlatform().runRepeatingSync((Runnable)new TabCompleteThread(), Long.valueOf(1L)); 
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar\\us\myles\ViaVersion\ViaManager.class
