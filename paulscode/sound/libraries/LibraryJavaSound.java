...
public class LibraryJavaSound extends Library {
  ...
  public static class MixerRanking {
    ...
    public void rank(Mixer.Info i) throws LibraryJavaSound.Exception {
      ...
      try {
        AudioFormat format = new AudioFormat(LibraryJavaSound.minSampleRate(false, 0), 16, 2, true, false);
      ...
      try {
        AudioFormat audioFormat1 = new AudioFormat(LibraryJavaSound.maxSampleRate(false, 0), 16, 2, true, false);
        lineInfo = new DataLine.Info(SourceDataLine.class, audioFormat1);
      } catch (Exception e) {
      ...
      if (this.minSampleRateOK) {
        ...
        while (uL - lL > 1) {
          ...
          AudioFormat audioFormat1 = new AudioFormat(testSampleRate, 16, 2, true, false);
          lineInfo = new DataLine.Info(SourceDataLine.class, audioFormat1);
          if (AudioSystem.isLineSupported(lineInfo)) {
      ...
      Clip clip = null;
      try {
        DataLine.Info clipLineInfo = new DataLine.Info(Clip.class, audioFormat);
...
/* Location:              C:\Users\Joona\Downloads\Cupid.jar!\paulscode\sound\libraries\LibraryJavaSound.class
